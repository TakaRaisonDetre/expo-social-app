...
export default  MessageScreen = () => {
    ...
    const renderPost = ({item}) =>(
         <PostContainer>
        <PostHeaderContainer>
            <PostProfilePhoto source = {{url:item.user.profilePhotoUrl}} />
            <PostInfoContainer>
     ...
     <Post>
         <Text>{item.post}</Text>
         <PostPhoto source={{url:item.photoUrl}}/>
         <PostDetails>
             <PostLikes>
             ...
             <PostComments>
                 <Ionicons name="ios-dchatbox" size={24} color="#73788b"/>
    ...
    return (
       ...
       <Container>
           <FeedContainer>
            ...
            <Feed data={tempData}  renderItem={renderPost} keyExtractor={
